...
namespace App\Http\Controllers\Api\Mobile\Recruiter\Credits;
...
class RecruiterCreditController extends Controller
{
    ...
    public function index(){
        ...
        return $this->success("packages", $data);
    ...
    public function buy_package(Request $request){
        ...
        $billing_info = array(
            ...
            "email" => $request->recruiterIs->email,
        ...
        if($charge){
            ...
            return $this->success("Package Purcahsed Successfully", $response);
        }
