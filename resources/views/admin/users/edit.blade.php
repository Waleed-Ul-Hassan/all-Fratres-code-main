...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <!-- Main content -->
        <div class="col-md-1">
            <a href="{{url('admin/add-users')}}" class="btn btn-block btn-info">View</a>
        </div>
        <br>
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <input type="hidden" value="{{$edit->id}}" name="id" class="form-control" id="id"/>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Email</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" name="type" id="type">
                                        ...
                                        <option value="Seo" @php if ($edit->type == 'Seo'){ echo 'selected';} @endphp>Seo</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-1">
                            <button type="button" onclick="update()" class="btn btn-block btn-info">Add</button>
                        </div>
                    </div>
                    <!-- /.card-body -->
