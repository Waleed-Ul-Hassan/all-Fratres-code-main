                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card card-primary">
                            ...
                            <form action="{{url('/admin/update-packages')}}" method="post">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="jobs"
                                               placeholder="e.g 3" value="{{$edit->jobs}}" id="jobs">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="features[]" id="features"
                                            ...
                                            @foreach($features as $featuress)
                                                <option value="{{$featuress->name}}" @if($fe && in_array($featuress->name, $fe)) selected @endif>{{$featuress->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
