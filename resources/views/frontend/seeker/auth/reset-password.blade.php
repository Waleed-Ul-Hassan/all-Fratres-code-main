                        ...
                        <div class="jobseeker-login-mainhead">
                            <div class="container h-100">
                                <div class="row h-100 justify-content-center align-items-center">
                                    <form class="col-lg-12 col-md-12" action="{{url('seeker/reset-password')}}" method="post">
                                        @csrf
                                        <input type="hidden" name="confirm_email_random_id" id="confirm_email_random_id" value="{{$seeker->confirm_email_random_id}}">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 d-flex justify-content-center align-items-center">
                                                    <div class="AppFormLeft width-80">
                                                        ...
                                                        <input type="submit" id="login-jobseeker" value="Update Paassword">
