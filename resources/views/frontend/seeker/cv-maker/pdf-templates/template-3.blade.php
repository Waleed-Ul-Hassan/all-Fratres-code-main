...
<div class="col-md-3" style=" position:absolute;right:10px;top:30px; ">
    ...
    <div class="skill_strength_resume_head" style="width:98%;background:#fff;margin-left:5px;">
        ...
        <p style="font-size: 12px;margin-left:25px;word-wrap: break-word;">{{$education->school}}</p>
...
<div class="col-md-9" style="display: inline-block;float:left;">
    ...
    <div class="fratres_resume_jobee_mainhead" style="display: inline-block;float:left;background-color: #fff !important;width:97% !important;">
        <div class="fratres_resume_item1" style="display: inline-block;float:left;background-color: #ffff !important;">
            <div class="fratres_resume_info_summary" style="width:92% !important;max-width:92% !important;background-color: #E0F5FF !important;">
                <div class="fratres_resume_info_logo">
                    ...
                    <div class="resume_details_fratres" style="margin-top: -10px;word-wrap: break-word;width:480px;max-width:480px;">
                        <div style="font-size: 22px;margin-left: 150px;">{{$seeker->first_name}} {{$seeker->last_name}} </div>
                        <div style="font-size: 13px;margin-left: 150px;color:#000;font-weight:normal;word-wrap: break-word;width:480px;max-width:480px;">{{$seeker->current_job_title}} @if($seeker->current_job_title != '') at {{$seeker->current_company}} @endif</div>
                    </div>
                </div>
                @if($seeker->summary != '')
                    <div class="resume_sumary_fulldetails" style="margin-top: -150px;font-size:13px;word-wrap: break-word;width:500px;max-width:500px;">
                        {!! strip_tags($seeker->summary) !!}
                    </div>
                @endif
            </div>
            <div class="fratres_resume_info_summary" style="width:90%;max-width:90%;background-color: #F7F7F7 !important;height:auto !important;">
                <div class="">
                    ...
                    <div class="" style="width:90%; margin-top: 15px !important; ">
                        ...
                        <ul style="padding-left: 0px !important;margin-left: 0px !important;margin-top: 10px !important;list-style-type: disc !important; width:90%;height: auto;padding-bottom: 0px; margin-bottom:0px !important;">
                            ...
                            @foreach(explode(",", $skills) as $skill)
                                ...
                                <li style="display:inline-block;width:33%;margin-bottom:10px !important;font-size: 13px;">
                                    {{$skill}}
                                </li>
                                @if( ($loop->index+1) %3==0)
                                    <p></p>
                        ...
                        <div class="" style="width:100%;margin-top:10px;">
                            ...
                            @foreach($experiences as $experience)
                                ...
                                <div class="exp_history_main" style="margin-left: -5px; width:100%;page-break-inside: auto;word-wrap: break-word;">
                                    <div class="exp_his_item1" style="background: #EFEFEF;padding:10px;border-radius:50%;page-break-inside: auto;">
                        ...
                        <div class="resume_details_fratres" style="width:97%;padding-bottom:20px; margin-bottom:10px;">
                            ...
                            @foreach($projects as $project)
                                ...
                                <div class="exp_history_main" style="margin-left: -20px; width:100%;">
                                    <div class="exp_his_item1" style="background: #EFEFEF;padding:10px;border-radius:50%;">
                                        <div class="font-16" style="color:#000;font-size:16px;font-weight:bold;word-wrap: break-word;">{{$project->project_title}}</div>
                                        <div style="font-size:14px;font-weight: normal">{{$project->company}}</div>
                                    </div>
                                    ...
                                    <div class="exp_his_item3" style="background: #EFEFEF;padding:10px;">
                                        ...
                                        <p  style="color:#000;float:right;font-size:11px;font-weight: normal;margin-top:20px;">(<a href="{{$project->project_url}}">{{$project->project_url}}</a>)</p>
                        ...
                        @if($certifications->count() > 0)
                            @foreach($certifications as $certification)
                                ...
                                <div class="exp_history_main" style="margin-left: -20px; width:100%;border-radius:50%;">
                                    ...
                                    <div class="exp_his_item3" style="background: #EFEFEF;padding:10px;word-wrap: break-word;">
                                        ...
                                        <h5  style="color:#000;float:right;font-size:11px;font-weight: normal;margin-top:20px;word-wrap: break-word;">(<a href="{{$certification->certification_url}}">{{$certification->certification_url}}</a>)</h5>
