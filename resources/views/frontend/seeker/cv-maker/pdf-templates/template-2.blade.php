...
{{--    <link  rel="stylesheet" href="{{asset('pdf/assets/fontawesome/css/all.css')}}">--}}
...
<div class="resume-wrapper text-center position-relative" style="width:100%;float:left;display:block;">
    <div class=" mx-auto text-left bg-white ">
        <header class="resume-header  pt-md-0" style="height:200px; background: #434E5E;">
            <div class="media flex-column flex-md-row" >
                ...
                <div class="media-body p-4 d-flex flex-column flex-md-row mx-auto mx-lg-0" style="width:70% !important;float:right; margin-left: 170px !important;padding: 20px !important;max-width:300px !important;">
                    <div class="primary-infosd" style="margin-top: 10px !important;">
                        ...
                        <div class="" style="font-size: 16px;margin-bottom:-5px;">{{$seeker->current_job_title}}</div>
                ...
                <div class="media-body p-4 d-flex flex-column flex-md-row mx-auto mx-lg-0" style="width:70% !important;float:right; margin-left: 500px !important;padding: 20px !important;border-left:2px solid #ececec !important;max-width:250px !important;">
                    ...
                    <div class="primary-infosd" style="margin-top: 10px !important;">
                        ...
                        <ul class="list-unstyled">
                            <li class="mb-2"><a href="#" style="font-size: 12px !important;word-break:break-all;">{{$education->degree ?? ''}} | {{$education->year ?? ''}} | {{$education->grade ?? ''}}</a></li>
                            <li class="mb-2" style="font-size: 12px !important; word-break:break-all ">{{$education->school ?? ''}}</li>
                        </ul>

                        <div style="margin-top: 10px !important;font-size:16px; font-weight:bold;"> Industries </div>
                        <ul class="list-unstyled">
                            <li class="mb-2"><a href="#">{{$industry->name ?? ''}}</a></li>
        ...
        <div class="resume-body ">
            ...
            <section class="resume-section summary-section mb-5">
                ...
                <div class="resume-section-content" style="word-break: break-all !important;word-wrap: break-word; max-width:95% !important;">
                    <p class="mb-0" style="font-size:13px; word-break:break-all !important;word-wrap: break-word; width:100%; max-width: 100% !important; ">{!! strip_tags($seeker->summary) !!}</p>
                </div>
            </section><!--//summary-section-->
            <section class="resume-section summary-section mb-5" style="background: #434E5E;padding:10px;">
                <h2 class="resume-section-title text-uppercase font-weight-bold pb-3 mb-3" style="color:#fff;">Skills</h2>
            ...
            <div class="row">
                                ...
                                <article class="resume-timeline-item position-relative pb-5" style="page-break-after: never;">
                                    ...
                                    <div class="resume-timeline-item-header mb-2" style="min-height:100px;">
                                        <div class="d-flex flex-column flex-md-row">
                                            <h3 class="resume-position-title font-weight-bold " style="max-width:300px; word-break:break-all !important;word-wrap: break-word; ">{{$experience->job_title}}</h3>
                                    ...
                                    <div class="resume-timeline-item-desc" style="margin-top: 20px !important;">
                                        <p style="margin-top: 10px !important; width:90%;  word-break:break-all !important;word-break:break-all !important;word-wrap: break-word; ">{{ strip_tags($experience->description)  }}</p>
                        ...
                        <div class="resume-section-content">
                            <div class="resume-timeline position-relative">
                                ...
                                <article class="resume-timeline-item position-relative pb-5">
                                    ...
                                    <div class="resume-timeline-item-header mb-2" style="min-height:100px;">
                                        <div class="d-flex flex-column flex-md-row">
                                            <h3 class="resume-position-title font-weight-bold " style="max-width:300px;word-wrap: break-word; ">{{$project->project_title}} <span style="font-size: 13px;">({{$project->project_url}})</span></h3>
                                            <div class=" ml-auto" style="margin-left:470px !important;font-size:12px;word-wrap: break-word; ">
                                                {{$project->company}}
                                            </div>
                                        </div><!--//row-->
                                        <div class="resume-position-time ml-auto" style="margin-top: -30px !important;font-size:13px;width:100% !important;display:block;margin-bottom:20px;word-wrap: break-word; ">{{date("M-Y", strtotime($project->date_start))}} - {{date("M-Y", strtotime($project->date_end))}}</div>
                                    </div><!--//resume-timeline-item-header-->
                                    <div class="resume-timeline-item-desc" style="margin-top: 20px !important;">
                ...
                <section class="resume-section summary-section mb-5" style="background: #434E5E;padding:10px;display:block;width:100%;page-break-before: always;margin-top: 0px;">
