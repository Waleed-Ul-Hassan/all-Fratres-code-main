...
@section('meta')
    <title>Online Job Search Engine Around The World | Fratres</title>
    ...
    <meta property="og:title" content="Explore Fratres Blogs By Categories | Fratres">
        ...
        <div class="container">
            <div class="jobblog-main">
                ...
                <div class="jobblog-main-menu">
                    ...
                    <ul id="desktopviewblogmenu">
                        ...
                        @foreach($categories as $category)
                            <li class="category-for-blog">
                                <div class="jobblogmenulist @if($category->slug==$id) active @endif">
                    ...
                    <div class="row">
                        @foreach($categoryBlogs as $randomBlog)
