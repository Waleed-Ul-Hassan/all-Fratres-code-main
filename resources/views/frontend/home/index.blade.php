        ...
        <div class="homepagesldier-form">
            <div class="container">
                <div class="homepageslider-form-title">
                    <h2> <span class="start-exchange-boostup">Get The Job You</span>  <span class="pause-play">Want</span> </h2>
                </div>
                <form action="{{url('search')}}" method="get">
                    <div class="homepageslider-form-head">
                        ...
                        <div class="homepagesldier-v2top">
                            <div class="form-group">
                                ...
                                <input type="text" id="example-ddg" name="location" class="form-control "
                                       placeholder="location / city / country" style="border-radius: 0px;">
                            </div>
                        </div>
                        <div class="homepagesldier-v4top">
                            <div class="form-group">

                                <select class="form-control border-radius" name="distance" id="">
                        ...
                        <div class="homepagesldier-v3top d-none d-md-block">
                            <button type="submit" class="btn btn-primary btn-searchbox-custom">Search</button>
                        </div>
                    </div>
                    <div class="homepage_moreoptions_head" id="moreoptionscontent">
                        <div class="homepage_moreoptions_v1">
                            <div class="form-group">

                                <input type="number" min="0" class="form-control" name="salary-min"
                                       id="exampleFormControlInput1" placeholder="Salary Min">
                            </div>
                        </div>
                        <div class="homepage_moreoptions_v2">
                            <div class="form-group">

                                <input type="number" min="0" class="form-control" name="salary-max"
                                       id="exampleFormControlInput1" placeholder="Salary Max">
                            </div>
                        </div>
                        <div class="homepage_moreoptions_v3">
                            <select class="form-control"  name="industry">
                                <option value="">--Select Industry--</option>
                                @foreach($industries as $industry)
                                    <option value="{{$industry->industry_slug}}">{{$industry->name}}</option>
                                @endforeach

                            </select>
                        </div>
                        <div class="homepage_moreoptions_v4">
                            <select class="form-control" id="positiontype" name="hours">
                    ...
                    <div class="homepage-moreoptions p-2" id="moresearch">
                        <p>More search options
                            <span><i class="fa fa-chevron-down rtoate180"></i></span>
                        </p>
                    </div>
                    <div class="homepagesldier-v3top d-xl-none d-lg-none d-md-none">
                            <button type="submit" class="btn btn-primary btn-searchbox-custom">Search</button>
                    </div>
                </form>
            </div>
            ...
            <div class="container">
                <div class="homepage-jobcate-head">
                    <ul class="nav nav-pills " id="pills-tab" role="tablist">
                        <li class="nav-item ">
                            <a class="nav-link tabs-homepage " id="pills-home-tab" data-toggle="pill"
                               href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">Jobs by
                                Sector </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link tabs-homepage active" id="pills-profile-tab" data-toggle="pill"
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <ul class="category">
                                            @foreach($industries as $indsutry)
                                                <li>
                                                    <a href="{{url('jobs/'.$indsutry->industry_slug)}}" class="link">
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <ul class="category">
                                            @foreach($cities as $city)
                                                ...
                                                <li>
                                                    <a href="{{url('jobs/in-'.$city->city_slug)}}" class="link">
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <ul class="category">
                                            @foreach($companies as $company)
                                                <li>
                                                    <a href="{{url('jobs-at/'.$company->company_name)}}" class="link">
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        <ul class="category">
                                            @foreach($companies as $company)
                                                @continue($loop->index <= 10)
                                                <li>
                                                    <a href="{{url('jobs-at/'.$company->company_name)}}"
                                                       class="link">
                                                        <span class="filter-name">{{$company->company_name}}</span>
                                                    </a>
                                                    <span class="filter-count"> ({{$company->total_jobs}})</span>
                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-6">
                                        ...
                                        <ul class="category">
                                            ...
                                            <li><a href="https://md.fratres.net">Jobs in Moldova </a></li>
                                            <li><a href="https://nl.fratres.net">Jobs in Netherlands </a></li>
                                            <li><a href="https://no.fratres.net">Jobs in Norway </a></li>
                                            <li><a href="https://pl.fratres.net">Jobs in Poland </a></li>
                                            <li><a href="https://pt.fratres.net">Jobs in Portugal </a></li>
                                            ...
                                            <li><a href="https://ua.fratres.net">Jobs in Ukraine</a></li>
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        ...
                                        <ul class="category">
                                            <li><a href="https://af.fratres.net">Jobs in Afghanistan</a></li>
                                            <li><a href="https://am.fratres.net">Jobs in Armenia</a></li>
                                            <li><a href="https://az.fratres.net">Jobs in Azerbaijan</a></li>
                                            <li><a href="https://bd.fratres.net">Jobs in Bangladesh</a></li>
                                            <li><a href="https://cy.fratres.net">Jobs in Cyprus</a></li>
                                            ...
                                            <li><a href="https://lk.fratres.net">Jobs in Sri Lanka</a></li>
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        ...
                                        <ul class="category">
                                            ...
                                            <li><a href="https://il.fratres.net"><span class="filter-name">Jobs in Israel</span></a>
                                            </li>
                                            <li><a href="https://kw.fratres.net"><span class="filter-name">Jobs in Kuwait</span></a>
                                            </li>
                                            <li><a href="https://lb.fratres.net"><span class="filter-name">Jobs in Lebanon</span></a>
                                            </li>
                                            <li><a href="https://qa.fratres.net"><span
                                                            class="filter-name">Jobs in Qatar</span></a></li>
                                            <li><a href="https://sa.fratres.net"><span class="filter-name">Jobs in Saudi Arabia</span></a>
                                            </li>
                                            <li><a href="https://ae.fratres.net"><span
                                                            class="">Jobs in UAE</span></a></li>
                                    ...
                                    <div class="col-md-3 col-sm-6">
                                        ...
                                        <ul class="category">
                                            ...
                                            <li><a href="https://za.fratres.net" class="link"><span class="filter-name">Jobs in South Africa</span></a>
                                            </li>
                                            <li><a href="https://tz.fratres.net" class="link"><span class="filter-name">Jobs in Tanzania</span></a>
                                            </li>
                                            <li><a href="https://ua.fratres.net" class="link"><span class="filter-name">Jobs in Uganda</span></a>
                                            </li>
                                            <li><a href="https://zw.fratres.net" class="link"><span class="filter-name">Jobs in Zimbabwe</span></a>
                                            </li>
                                        </ul>
                                        <div class="country-heading">
                        ...
                        <div class="splide">
                            <div class="splide__track">
                                <ul class="splide__list">
                                    @foreach($companies as $company)
                                        <li class="splide__slide" onclick="window.location.href='{{url('company/'.$company->company_slug)}}'">
                                            <img src="{{asset('recruiters/profile/'.getDomainRoot().'square_'.$company->company_logo)}}">
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
...
{{--                                @break($loop->index == 10)--}}
{{--                                <a href="{{url('company/'.$company->companySlug())}}">--}}
{{--                                    <div class="item" style="background: url('{{asset('recruiters/profile/'.getDomainRoot().'square_'.$company->company_logo)}}') ; background-position: center;background-repeat: no-repeat;background-size: contain; height: 100px;">--}}
{{--                                    </div>--}}
{{--                                </a>--}}
{{--                            @endforeach--}}
{{--                        </div>--}}
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-md-6 col-sm-12">
                        <div class="icon-box">
                            ...
                            <h3>Search Jobs</h3>
                            <p>Search for your dream job. Our powerful Algorithms will help you land your next big
                                career.</p>
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6 col-sm-12">
                        <div class="icon-box">
                            ...
                            <h3>Save &amp; Apply</h3>
                            <p>Save Your CV and generate a public link to show to recruiters or Download CV in different
                                Templates as well</p>
                        </div>
                    </div>
                </div>
...
@section('scripts')
{{--    <link rel="prefetch" as="script" href="{{url('frontend/autocomplete/jquery.easy-autocomplete.min.js')}}" >--}}
    {{--<noscript><script src="{{url('frontend/autocomplete/jquery.easy-autocomplete.min.js')}}" ></script></noscript>--}}
    {{--<link rel="prefetch" as="script" href="https://cdnjs.cloudflare.com/ajax/libs/gsap/1.16.1/TweenMax.min.js">--}}
