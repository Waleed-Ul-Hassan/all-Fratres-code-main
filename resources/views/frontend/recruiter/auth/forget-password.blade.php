                        ...
                        <div class="jobseeker-login-mainhead">
                            <div class="container h-100">
                                <div class="row h-100 justify-content-center align-items-center">
                                    <form class="col-lg-12 col-md-12" action="{{url('recruiter/forget-password')}}" method="post">
                                        @csrf
                                            ...
                                            <a href="register.html">  Create your account</a>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="AppFormRight">
                                                        ...
                                                        <ul>
                                                            <li><a href="#"><span class="hidden-xs hidden-sm"><i class="fas fa-check-circle"></i></span>be featured in the top search result</a></li>
                                                            <li><a href="#"><span><i
