...
<main>
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 align-self-center">
				<img src="https://pk.fratres.net/logo/logo-uploaded.png" alt="">
				<h2 class="mt-5">Happy New Year</h2>
				{{--<h2>UH OH! You're lost.</h2>--}}
				<p>While you're celebrating new year, We are upgrading our system for better reach, please check back soon.
				</p>
